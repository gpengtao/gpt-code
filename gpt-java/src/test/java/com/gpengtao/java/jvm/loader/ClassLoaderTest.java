	...
	public void test_my_impl_class_loader() throws ClassNotFoundException, IllegalAccessException, InstantiationException {
		...
		ClassLoader myClassLoader = new ClassLoader() {
			...
			public Class<?> loadClass(String className) throws ClassNotFoundException {
				System.out.println("myClassLoader 准备 load class : " + className);
		...
		System.out.println("class loader: " + HashMap.class.getClassLoader());
	}

	@Test
	public void test_real_class_loader() throws ClassNotFoundException {
		...
		ClassLoader myClassLoader = new ClassLoader() {
			...
			public Class<?> loadClass(String className) throws ClassNotFoundException {
				...
				System.out.println("当前线程的class loader : " + classLoader);

				return classLoader.loadClass(className);
			}
		};

		Class<?> aClass = myClassLoader.loadClass("com.gpengtao.java.jvm.loader.MyClass");

		System.out.println("classLoader是: " + aClass.getClassLoader());
	}
